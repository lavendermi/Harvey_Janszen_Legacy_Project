...
3.  Follow the instructions in Part 4 to clean taxa names
    ...
    -   Click on the "matchType" column label to order these by match type
        ...
        -   place this downloaded file in data \> digitized_data \> occurrence_data \> occurrence_reference_data \> taxonomy with the name "normalized"
...
4.  Run the initial part of step 5 (Georeferencing) up until the .csv file is written. Then follow the following instructions for referencing protocol in GEOlocate:
    ...
    -   upload the .csv file from data \> digitized_data \> occurrence_data \> occurrence_reference_data \> georeferencing \> "localities-to-georef_Xdate.csv"
    ...
    -   once all localities have been georeferenced, export the file by..
        ...
        -   place the exported file in data \> digitized_data \> occurrence_data \> occurrence_reference_data \> georeferencing
