...
4.  Follow the instructions in Part 4 to clean taxa names
    ...
    -   Review the outputs page by page, paying attention to the "matchType" column.
...
5.  Run the initial part of step 5 (Georeferencing) up until the .csv file is written. Then follow the following instructions for referencing protocol in GEOlocate:
