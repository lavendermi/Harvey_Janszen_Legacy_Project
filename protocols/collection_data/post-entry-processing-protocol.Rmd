...
## **Processing Step IV: Assigning Associate observation-only occurrences listed as associates in notes**

-   In order to obtain associate species for the observation-only associates noted collection notes, observation-only data must be entered for these pages

-   Then, the script: <https://github.com/emench/Harvey_Janszen_Legacy_Project/blob/main/scripts/aggregation/total-occurrence-aggregation.R>

-   The final output will be a file in the "darwin_core_data" folder that is named "Final-DwC"
